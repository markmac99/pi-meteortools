...
ssh allsky2 "hostname && sudo apt-get update && sudo apt-get upgrade -y"
...
ssh testpi5 "hostname && sudo apt-get update && sudo apt-get upgrade -y"
ssh wxsatpi "hostname && sudo apt-get update && sudo apt-get upgrade -y"
ssh ohserver "hostname && sudo apt-get update && sudo apt-get upgrade -y"
...
ssh weatherpi3 "hostname && sudo apt-get update && sudo apt-get upgrade -y"
...
ssh thelinux "hostname && sudo apt-get update && sudo apt-get upgrade -y"